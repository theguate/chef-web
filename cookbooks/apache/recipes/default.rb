...
execute " rm /etc/httpd/conf.d/userdir.conf" do
        only_if do
                File.exist?("/etc/httpd/conf.d/userdir.conf")
        end
        notifies :restart, "service[httpd]"
end

execute " rm /etc/httpd/conf.d/autoindex.conf" do
        only_if do
                File.exist?("/etc/httpd/conf.d/autoindex.conf")
        end
        notifies :restart, "service[httpd]"
end
